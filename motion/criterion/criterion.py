...
class SimpleCriterion(BaseCriterion):
    ...
    @call_func_monitor
    @time_monitor
    def compute_result(self, outputs, epoch=0, split="test"):
        ...
        if self.save_results:
            self._save_process_result(process_outputs, epoch, split)
    ...
    def _save_process_result(self, processoutput, epoch, split):
        pass
